...
add_action('factory_000_plugin_activation', 'FactoryTypes000::activationHook');
add_action('factory_000_plugin_deactivation', 'FactoryTypes000::deactivationHook');
 ...
 * @since 1.0.0
 */
class FactoryTypes000 {
    
    /**
     * Registered custom types.
     * 
     * @since 1.0.0
     * @var FactoryTypes000_Type[] 
     */
