 ...
 * @since 1.0.0
 */
abstract class FactoryTypes000_Type {
    ...
    public function __construct( $plugin ) {
        ...
        $this->menu = new FactoryTypes000_Menu( $this );
    ...
    public function registerForAdmin() {
        ...
        foreach($this->metaboxes as $metabox) {
            FactoryMetaboxes000::registerFor($metabox, $this->name, $this->plugin);
        }
        ...
        if ( $this->template !== 'public') {
            //FactoryMetaboxes000::registerFor('FactoryMetaboxes000_PublishMetabox', $this->name);
    ...
    private function buildLables() {
        ...
        $labels = array(
            ...
            'name' => $pluralName,          
            'all_items' => sprintf( __('All %1$s', 'factory_types_000'), $pluralName ),
            'add_new' => sprintf( __('Add %1$s', 'factory_types_000'), $singularName ),
            'add_new_item' => sprintf( __('Add new', 'factory_types_000'), $singularName ),
            'edit' => sprintf( __('Edit', 'factory_types_000') ),
            'edit_item' => sprintf( __('Edit %1$s', 'factory_types_000'), $singularName ),
            'new_item' => sprintf( __('New %1$s', 'factory_types_000'), $singularName ),
            'view' => sprintf( __('View', 'factory_types_000') ),
            'view_item' => sprintf( __('View %1$s', 'factory_types_000'), $singularName ),
            'search_items' => sprintf( __('Search %1$s', 'factory_types_000'), $pluralName ),
            'not_found' => sprintf( __('No %1$s found', 'factory_types_000'), $pluralName ),
            'not_found_in_trash' => sprintf( __('No %1$s found in trash', 'factory_types_000'), $pluralName ),
            'parent' => sprintf( __('Parent %1$s', 'factory_types_000'), $pluralName )
        );
    ...
    public function actionUpdatedMessages( $messages ) 
    {
        ...
        $replacements = array(
            ...
            array('{scheduled}', date_i18n( __( 'M j, Y @ G:i', 'factory_types_000' ), strtotime( $post->post_date ) ) )
        );
